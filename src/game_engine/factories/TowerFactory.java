...
public class TowerFactory {
    ...
    public Tower defineTowerModel (BuildingBlock block) {
        ...
        UnitProperties towerProp =
                new UnitProperties(hp, null, null, velo, null, null, null, towerState, towerPath);
    ...
    public Tower createHomingTower (String name,
        ...
        UnitProperties properties =
                new UnitProperties(new Health(1), null, null, velocity, b,
                                   startingPosition.copyPosition(), null, st, p2);
    ...
    public Tower createTackTower (String name,
        ...
        p2.addPosition(startingPosition.copyPosition());
        p2.addPosition(new Position(startingPosition.getX(), startingPosition.getY()-900));
        UnitProperties properties = new UnitProperties(h, null, null, velocity, b, startingPosition.copyPosition(), null, st, p2);
        Affector damage = myAffectorLibrary.getAffector("Constant", "HealthDamage");
        damage.setTTL(1);
        ...
        pp2.getProperties().setPath(path2);
        ...
        pp3.getProperties().setPath(path3);
        ...
        pp4.getProperties().setPath(path4);
        ...
        pp5.getProperties().setPath(path5);
        ...
        pp6.getProperties().setPath(path6);
        ...
        pp7.getProperties().setPath(path7);
        ...
        pp8.getProperties().setPath(path8);
    ...
    public Tower createSpecifiedTower (String name,
                                       List<Unit> allProjectiles,
                                       List<Unit> myTowers,
                                       List<Projectile> myProjectiles) {
        List<Affector> affectors = new ArrayList<>();
        Tower t = new Tower(name, affectors, allProjectiles, myProjectiles, myTowers, 2);
        List<Position> l1 = new ArrayList<>();
        l1.add(new Position(0, 0));
        ...
        UnitProperties properties2 =
                new UnitProperties(health2, null, null, velocity2, b, position2, null, st, p2);
