...
public class TowerFactory {
	...
	public Tower defineTowerModel(BuildingBlock block){
		...
		Tower t = new Tower(tBlock.getMyName(), Arrays.asList(new Timeline(Arrays.asList(affectors))), null, null, null, 2);
	...
	public Tower createTackTower (String name,
		...
		Projectile p = new Projectile("Tack", Arrays.asList(new Timeline(Arrays.asList(Arrays.asList(move)))), 3);
		p.setDeathDelay(30);
		p.setTTL(30);
		p.setFireRate(90);
		...
		p.setTimelinesToApply(Arrays.asList(new Timeline(Arrays.asList(Arrays.asList(new Affector[]{damage, stateToDamaging})))));
	...
	public Tower createHomingTower (String name,
		...
		move.setTTL(Integer.MAX_VALUE);
		Projectile p = new Projectile("Projectile", Arrays.asList(new Timeline(Arrays.asList(Arrays.asList(move)))), 3);
		p.setDeathDelay(15);
		p.setTTL(1000000);
		p.setFireRate(90);
	...
	public Tower createSpecifiedTower(String name, List<Unit> myProjectiles2, List<Unit> myTowers, List<Projectile> myProjectiles) {
		List<Affector> affectors = new ArrayList<>();
		Tower t = new Tower(name, Arrays.asList(new Timeline(Arrays.asList(affectors))), myProjectiles2, myProjectiles, myTowers, 2);
		List<Position> l1 = new ArrayList<>();
		l1.add(new Position(0,0));
