...
public class AISearcher {
    ...
    public List<Branch> getShortestPathToGoal (Position start,
                                               Position goal,
                                               List<Branch> visibilityBranches) {
    ...
    public List<Branch> dijkstrasShortestPath (Branch start,
                                               Branch goal,
                                               List<Branch> visibilityBranches) {
    ...
    public double getManhattanDistance (Position current, Position goal) {
        return Math.sqrt(Math.pow(current.getX(), goal.getY()) +
                         Math.pow(current.getY(), goal.getY()));
    }
    ...
    private HashMap<Branch, List<Branch>> getBFSVisitedMap (List<Branch> visibilityBranches,
                                                            Position current) {
        ...
        for (Branch start : startBranches) {
            ...
            while (!queue.isEmpty()) {
                ...
                Branch child = null;
                while ((child =
                        getUnvisitedChildNode(branch, visited, visibilityBranches)) != null) {
                    visited.add(child);
                    queue.add(child);
                }
            }
    ...
    private Branch getUnvisitedChildNode (Branch branch,
                                          List<Branch> visited,
                                          List<Branch> visible) {
