...
public class StoreTab extends Tab implements IWorkspace {
	...
	private void refresh() {
		...
		myStoreTabModel.getStoreFactory()
				.setAffectorLibrary(this.myAuthModel.getIAuthEnvironment().getAffectorFactory().getAffectorLibrary());
		myStoreTabModel.getStoreFactory()
				.setUnitLibrary(this.myAuthModel.getIAuthEnvironment().getUnitFactory().getUnitLibrary());
	}
