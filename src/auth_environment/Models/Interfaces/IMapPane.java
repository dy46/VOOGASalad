...
/*It was a challenging decision when deciding how to organize the map panes because it was a choice
between using interfaces and class hierarchy (extends subclass). While interfaces provide more flexibility in terms of the individual 
