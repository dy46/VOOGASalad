...
public class TextBot {
    ...
    public void sendText (String message, List<String> names) throws TwilioRestException {
        ...
        for (String name : names) {
            ...
            params.add(new BasicNameValuePair("To", myResources.getString(name.toLowerCase()))); // Replace
                                                                                                 // with
                                                                                                 // a
                                                                                                 // valid
                                                                                                 // phone
                                                                                                 ...
                                                                                                 // your
                                                                                                 // account.
            params.add(new BasicNameValuePair("From", MY_NUMBER)); // Replace with a valid phone
